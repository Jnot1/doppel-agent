...
def cron_list(show_all: bool = False):
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: doppel gateway install", Colors.DIM))
        print(color("                    sudo doppel gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    doppel gateway install    # Install as a user service")
        print("    sudo doppel gateway install --system  # Linux servers: boot-time system service")
        print("    doppel gateway            # Or run in foreground")
...
def cron_command(args):
    ...
    print("Usage: doppel cron [list|create|edit|pause|resume|run|remove|status|tick]")
    sys.exit(1)
