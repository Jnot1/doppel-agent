...
def mcp_command(args):
    ...
    if handler:
        ...
        _info("doppel mcp catalog                            List Nous-approved MCPs")
        _info("doppel mcp install <name>                     Install a catalog MCP")
        _info("doppel mcp serve                              Run as MCP server")
        _info("doppel mcp add <name> --url <endpoint>        Add a custom MCP server")
        _info("doppel mcp add <name> --command <cmd>         Add a stdio server")
        _info("doppel mcp add <name> --preset <preset>       Add from a known preset")
        _info("doppel mcp remove <name>                      Remove a server")
        _info("doppel mcp list                               List configured servers")
        _info("doppel mcp test <name>                        Test connection")
        _info("doppel mcp configure <name>                   Toggle tools")
