...
Usage:
    doppel pairing list              # Show all pending + approved users
    doppel pairing approve <platform> <code>  # Approve a pairing code
    doppel pairing revoke <platform> <user_id> # Revoke user access
    doppel pairing clear-pending     # Clear all expired/pending codes
"""
...
def pairing_command(args):
    ...
    if action == "list":
        ...
        print("Usage: doppel pairing {list|approve|revoke|clear-pending}")
        print("Run 'doppel pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'doppel pairing list' to see pending codes.\n")
