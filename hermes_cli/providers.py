...
2. **Doppel overlays** — transport type, auth patterns, aggregator flags,
...
# -- Doppel overlay ----------------------------------------------------------
# Doppel-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class HermesOverlay:
    """Doppel-specific provider metadata layered on top of models.dev."""
...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "qwen-oauth": HermesOverlay(
        ...
        base_url_env_var="DOPPEL_QWEN_BASE_URL",
    ),
