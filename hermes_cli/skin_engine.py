...
- ``default`` — Classic Doppel gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Doppel — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Doppel Agent",
            "welcome": "Welcome to Doppel Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Doppel ",
            "prompt_symbol": "❯",
