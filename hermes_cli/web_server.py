...
app = FastAPI(title="Doppel Agent", version=__version__)
...
def _anthropic_oauth_status() -> Dict[str, Any]:
    ...
    Doppel resolves Anthropic creds in this order at runtime:
    ...
    if hermes_creds and hermes_creds.get("accessToken"):
        return {
            "logged_in": True,
            "source": "hermes_pkce",
            "source_label": f"Doppel PKCE ({_HERMES_OAUTH_FILE})",
...
def _claude_code_only_status() -> Dict[str, Any]:
    ...
    Claude Code subscription tokens are actively flowing into Doppel even
...
_OAUTH_PROVIDER_CATALOG: tuple[Dict[str, Any], ...] = (
    {
        ...
        "flow": "pkce",
        "cli_command": "doppel auth add anthropic",
    ...
    },
    {
        ...
        "name": "Nous Portal",
        "flow": "device_code",
        "cli_command": "doppel auth add nous",
    ...
    },
    {
        ...
        "flow": "device_code",
        "cli_command": "doppel auth add openai-codex",
    ...
    },
    {
        ...
        "flow": "external",
        "cli_command": "doppel auth add qwen-oauth",
    ...
    },
    {
        ...
        "flow": "device_code",
        "cli_command": "doppel auth add minimax-oauth",
...
def _save_anthropic_oauth_creds(access_token: str, refresh_token: str, expires_at_ms: int) -> None:
    """Persist Anthropic PKCE creds to both Doppel file AND credential pool.
...
def _resolve_chat_argv(
    ...
    Default: whatever ``doppel --tui`` would run.  Tests monkeypatch this
...
def _discover_dashboard_plugins() -> list:
    ...
    3. Project plugins: ./.doppel/plugins/  (legacy ./.hermes/plugins/ also works)
    """
    plugins = []
    seen_names: set = set()
    ...
    if env_var_enabled("DOPPEL_ENABLE_PROJECT_PLUGINS") or env_var_enabled("HERMES_ENABLE_PROJECT_PLUGINS"):
        search_dirs.append((Path.cwd() / ".doppel" / "plugins", "project"))
            ...
            try:
                ...
                for tname in provides_tools:
                    ...
                    if entry and entry.check_fn and not entry.check_fn():
                        auth_required = True
                        auth_command = f"doppel auth {name}"
                        break
            except Exception:
                pass
