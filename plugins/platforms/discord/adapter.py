...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Doppel session")
        ...
        @tree.command(name="status", description="Show Doppel session status")
        ...
        @tree.command(name="stop", description="Stop the running Doppel agent")
        ...
        @tree.command(name="reload-skills", description="Re-scan ~/.doppel/skills/ for new or removed skills")
        ...
        @tree.command(name="update", description="Update Doppel Agent to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="restart", description="Gracefully restart the Doppel gateway")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Doppel session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Doppel in the thread",
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Doppel: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Doppel"
        if len(content) > 80:
        ...
        try:
            ...
            try:
                seed_msg = await message.channel.send(f"\U0001f9f5 Thread created by Doppel: **{thread_name}**")
                thread = await seed_msg.create_thread(
                    name=thread_name,
    ...
    async def create_handoff_thread(
        ...
        try:
            ...
            if send is None:
                return None
            seed_msg = await send(f"\U0001f9f5 Doppel handoff: **{thread_name}**")
            thread = await seed_msg.create_thread(
                name=thread_name,
                auto_archive_duration=1440,
                reason=reason,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'doppel-agent[messaging]'",
