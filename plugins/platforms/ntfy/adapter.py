...
``plugins/platforms/ntfy/``. The Doppel plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "doppel-in"              # subscribe topic (incoming)
          publish_topic: "doppel-out"     # optional — defaults to topic
...
_ECHO_TAG = "doppel-agent"  # tag added to outgoing messages for echo-loop prevention
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Doppel dependency",
