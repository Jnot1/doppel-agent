#!/usr/bin/env python3
"""Build the Doppel Skills Index — a centralized JSON catalog of all skills.
...
`doppel skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Doppel Skills Index...", flush=True)
