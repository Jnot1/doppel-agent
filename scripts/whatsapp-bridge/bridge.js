...
const SESSION_DIR = getArg('session', path.join(process.env.HOME || '~', '.doppel', 'whatsapp', 'session'));
const IMAGE_CACHE_DIR = path.join(process.env.HOME || '~', '.doppel', 'image_cache');
const DOCUMENT_CACHE_DIR = path.join(process.env.HOME || '~', '.doppel', 'document_cache');
const AUDIO_CACHE_DIR = path.join(process.env.HOME || '~', '.doppel', 'audio_cache');
