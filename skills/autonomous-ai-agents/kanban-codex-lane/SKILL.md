...
description: Use when a Doppel Kanban worker wants to run Codex CLI as an isolated implementation lane while Doppel keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Doppel Agent
license: MIT
metadata:
