...
description: Modify, debug, or extend the s6-overlay supervision tree inside the Doppel Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.
version: 1.0.0
author: Doppel Agent
license: MIT
metadata:
  hermes:
    ...
    docs_display_name: Doppel S6 Container Supervision
