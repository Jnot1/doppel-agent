...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateHermes: "Mettre à jour Doppel Agent",
    updatingHermes: "Mise à jour de Doppel Agent…",
  ...
  pluginsPage: {
    ...
    headline: "Découvrez, installez, activez et mettez à jour les plugins Doppel (parité avec `doppel plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.doppel/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.doppel/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.doppel/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle: "Badges Doppel à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle: "Analyse de l'historique des sessions Doppel en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Doppel davantage",
    ...
    guide: {
      ...
      secret_body: "Les secrets cachent leur déclencheur exact. Dès que Doppel détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body: "Doppel analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
