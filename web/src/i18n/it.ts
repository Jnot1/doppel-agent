...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateHermes: "Aggiorna Doppel Agent",
    updatingHermes: "Aggiornamento di Doppel Agent…",
  ...
  pluginsPage: {
    ...
    headline: "Scopri, installa, abilita e aggiorna i plugin Doppel (parità con `doppel plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.doppel/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.doppel/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.doppel/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle: "Badge Doppel da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle: "Scansione della cronologia delle sessioni Doppel in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Doppel di più",
    ...
    guide: {
      ...
      secret_body: "I segreti nascondono il loro trigger esatto. Quando Doppel rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body: "Doppel sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
