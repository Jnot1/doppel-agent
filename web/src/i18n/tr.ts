...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateHermes: "Doppel Agent'i Güncelle",
    updatingHermes: "Doppel Agent güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline: "Doppel eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`doppel plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.doppel/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.doppel/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.doppel/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle: "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Doppel rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle: "Doppel oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Doppel'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body: "Sırlar, tetikleyicilerini saklı tutar. Doppel ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body: "Doppel yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
