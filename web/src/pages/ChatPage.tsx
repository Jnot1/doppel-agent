/**
 * ChatPage — embeds `doppel --tui` inside the dashboard.
 *
...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      // even when the inner Doppel TUI has enabled xterm mouse-events
    ...
    // forwarding them into Doppel. Keyboard input, paste, and resize still
    // behave normally.
