...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Doppel Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Doppel tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Doppel core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Doppel Plugin](/guides/build-a-hermes-plugin)
...
- [ ] Tested with `doppel chat -q "Use the weather tool for London"`
