...
See [Building a Doppel Plugin](/guides/build-a-hermes-plugin#distribute-via-pip) for the full entry-points setup.
...
- [Building a Doppel Plugin](/guides/build-a-hermes-plugin) — general plugin authoring
