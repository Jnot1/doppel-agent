...
description: "Doppel Agent is your everyday personal AI assistant with tools, memory, automation, and messaging workflows."
...
Doppel Agent is **Your Everyday Personal AI Assistant**. It is maintained by Doppelme for everyday operations like email triage, calendar organization, grocery planning, to-do management, personal training support, cooking help, and deep technical workflows.
...
| 🧭 **[Use MCP with Doppel Agent](/guides/use-mcp-with-doppel-agent)** | Practical MCP setup patterns, examples, and tutorials |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Doppel Agent |
...
- **Built for daily life and serious work** — Maintained by Doppelme for everyday operations. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Original upstream attribution is preserved in [NOTICE.md](https://github.com/Jnot1/doppel-agent/blob/main/NOTICE.md)
