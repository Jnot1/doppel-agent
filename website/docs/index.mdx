...
slug: /
sidebar_position: 0
title: "Doppel Agent Documentation"
description: "Doppel Agent is Your Everyday Personal AI Assistant: a customer-facing fork of Hermes Agent with tools, memory, automation, and messaging workflows."
...
Doppel Agent is **Your Everyday Personal AI Assistant**. It is a modified fork of Hermes Agent by Nous Research, maintained by Doppelme for everyday operations like email triage, calendar organization, grocery planning, to-do management, personal training support, cooking help, and deep technical workflows.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/Jnot1/doppel-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
After installing, run `doppel setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Doppel Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Doppel safely |
| 🧭 **[Use MCP with Doppel](/guides/use-mcp-with-hermes)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Doppel Agent](/guides/use-voice-mode-with-doppel-agent)** | Hands-on setup and usage patterns for Doppel Agent voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Doppel's default voice with a global SOUL.md |
...
- **Built for daily life and serious work** — Maintained by Doppelme as a customer-facing fork of Hermes Agent. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Original Hermes Agent attribution is preserved in [NOTICE.md](https://github.com/Jnot1/doppel-agent/blob/main/NOTICE.md)
