...
| [`Doppel Agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-doppel-agent) | Configure, extend, or contribute to Doppel Agent. | `autonomous-ai-agents/doppel-agent` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`Debugging Doppel TUI Commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-doppel-tui-commands) | Debug Doppel TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-doppel-tui-commands` |
| [`Doppel Agent Skill Authoring`](/docs/user-guide/skills/bundled/software-development/software-development-doppel-agent-skill-authoring) | Use when authoring in-repo SKILL.md for Doppel Agent: frontmatter, validator, structure. | `software-development/doppel-agent-skill-authoring` |
| [`Doppel S6 Container Supervision`](/docs/user-guide/skills/bundled/software-development/software-development-doppel-s6-container-supervision) | Modify, debug, or extend the s6-overlay supervision tree inside the Doppel Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern. | `software-development/doppel-s6-container-supervision` |
