...
| Google Gemini (OAuth) | `google-gemini-cli` | `doppel model` (Google OAuth; optional: `DOPPEL_GEMINI_PROJECT_ID`) |
...
| Qwen Portal (OAuth) | `qwen-oauth` | `doppel model` (Qwen Portal OAuth; optional: `DOPPEL_QWEN_BASE_URL`) |
