---
title: "Doppel S6 Container Supervision"
sidebar_label: "Doppel S6 Container Supervision"
description: "Modify, debug, or extend the s6-overlay supervision tree inside the Doppel Agent Docker image — adding new services, debugging profile gateways, understandin..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Doppel S6 Container Supervision

Modify, debug, or extend the s6-overlay supervision tree inside the Doppel Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.
...
| Related skills | [`hermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-doppel-agent), `hermes-agent-dev` |
...
# Doppel s6-overlay Container Supervision

## When to use this skill

Load this skill when you're working on:
- Adding or removing a static service in the Doppel Agent Docker image (something that should be supervised at every container start, like the dashboard)
...
If you're just running Doppel Agent and want to use Docker, see `website/docs/user-guide/docker.md` instead.
