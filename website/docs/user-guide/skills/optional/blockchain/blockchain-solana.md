...
| | |
|---|---|
| Source | Optional — install with `doppel skills install official/blockchain/solana` |
...
```bash
python3 ~/.doppel/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.doppel/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.doppel/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.doppel/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.doppel/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
