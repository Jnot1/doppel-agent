...
| | |
|---|---|
| Source | Optional — install with `doppel skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Doppel Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.doppel/.env`:
