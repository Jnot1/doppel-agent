...
| | |
|---|---|
| Source | Optional — install with `doppel skills install official/productivity/memento-flashcards` |
...
```bash
python3 ~/.doppel/skills/productivity/memento-flashcards/scripts/memento_cards.py due --collection "History"
```
...
```bash
python3 ~/.doppel/skills/productivity/memento-flashcards/scripts/memento_cards.py add-quiz \
  --video-id "VIDEO_ID" \
...
```bash
python3 ~/.doppel/skills/productivity/memento-flashcards/scripts/memento_cards.py stats
python3 ~/.doppel/skills/productivity/memento-flashcards/scripts/memento_cards.py add --question "Capital of France?" --answer "Paris" --collection "General"
python3 ~/.doppel/skills/productivity/memento-flashcards/scripts/memento_cards.py due
```
