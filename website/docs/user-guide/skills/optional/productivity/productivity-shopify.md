...
| | |
|---|---|
| Source | Optional — install with `doppel skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Doppel","productType":"Apparel","tags":["test"]}}'
```
