...
想让 Doppel 拥有稳定的默认风格？编辑 `~/.doppel/SOUL.md`（如果使用自定义 Doppel home，则为 `$DOPPEL_HOME/SOUL.md`）。Doppel 现在会自动生成一个初始 SOUL 文件，并将该全局文件作为实例级个性来源。

完整说明请参阅 [在 Doppel Agent 中使用 SOUL.md](/guides/use-soul-with-doppel-agent)。
