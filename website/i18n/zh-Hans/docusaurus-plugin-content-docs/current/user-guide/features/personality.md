...
如果文件为空、仅含空白字符或无法读取，Doppel Agent 将回退到内置默认身份（"You are Doppel Agent, an intelligent AI assistant created by Nous Research..."）。当 `skip_context_files` 被设置时（例如在子 Agent/委托上下文中），同样适用此回退。
